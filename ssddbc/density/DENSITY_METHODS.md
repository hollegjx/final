...
```python
from ssddbc.density.density_estimation import compute_relative_density
...
```bash
# 方法0：平均距离倒数（默认）
python -m ssddbc.testing.main --dense_method 0

# 方法1：中位数距离倒数
python -m ssddbc.testing.main --dense_method 1

# 方法2：归一化倒数密度
python -m ssddbc.testing.main --dense_method 2

# 方法3：指数密度
python -m ssddbc.testing.main --dense_method 3
```
