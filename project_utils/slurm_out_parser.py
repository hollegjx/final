...
from config import slurm_log_base_pattern, slurm_summary_root
...
save_root_dir = slurm_summary_root
...
save_dir = slurm_summary_root
base_path = slurm_log_base_pattern
