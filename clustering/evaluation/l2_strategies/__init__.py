...
from .information import compute_mutual_info_component
from .consistency import compute_cluster_consistency_component
...
L2_REGISTRY: Dict[str, Dict[str, object]] = {
    ...
    'penalty': {
        'fn': compute_penalty_component,
        'orientation': 'minimize',
        'description': '局部密度惩罚，值越小越好'
    },
    # 预留扩展策略
    'mutual_info': {
        'fn': compute_mutual_info_component,
        'orientation': 'maximize',
        'description': '互信息占位策略，后续实现'
    },
    'cluster_consistency': {
        'fn': compute_cluster_consistency_component,
        'orientation': 'maximize',
        'description': '簇内一致性占位策略，后续实现'
    },
    'silhouette': {
